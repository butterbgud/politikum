...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} body{margin:0; color:#fff; font-family: ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Arial;}
    ...
    .pill{background:rgba(0,0,0,.55); border:1px solid rgba(245,209,122,.18); border-radius:0; padding:8px 10px; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace; font-weight:900; font-size:18px; color:rgba(255,255,255,.88); letter-spacing:.04em; box-shadow:none; white-space:nowrap;}
    ...
    <div class="panel">
      <div class="hero">
        <div class="art artWrap">
          <div class="artTop"><div class="pill">R:${rating} G:${games} W:${wins}</div></div>
